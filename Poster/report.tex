...
The average accuracy of the optimized support vector machines on each representative's test set was 84.62\%, while the baseline model had an average accuracy of 80.80\% on those same test sets. Thus the optimized support vector machine had an average accuracy 3.82\% higher than that of the baseline model.
...
\begin{figure*}[t]
\includegraphics[width=\linewidth]{size_accuracy.png}
